...
const Login = () => {
    ...
    const handleLogin = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (result) navigate("/admin/profile");
    };
                        ...
                        <div className="card border-0 shadow-lg rounded-4 bg-white">
                            <div className="card-body p-3 p-md-4 p-xl-5">
                                    ...
                                    <div className="row gy-3">
                                        {auth?.success && (
                                            <div className="col-12">
                                                <div className="alert alert-success text-center">{auth.success}</div>
                                            </div>
                                        )}
                                        {auth?.error && (
                                            <div className="col-12">
                                                <div className="alert alert-danger text-center">{auth.error}</div>
                                            </div>
                                        )}
                                        <div className="col-12">
                                        ...
                                        <div className="col-12">
                                            <button type="submit" className="btn btn-success w-100 py-3 fw-semibold">
                                                Login Now
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div className="text-center">
                                    <Link to="/admin/signup" className="text-decoration-none text-dark">Create new account</Link>
                                </div>
                            </div>
                        </div>
                    </div>
