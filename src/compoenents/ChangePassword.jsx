                    ...
                    <div className="card border-0 shadow">
                        ...
                        <div className="card-body">
                            <div className="mb-3">
                                ...
                                <input type="password" className="form-control" placeholder="Old Password" name="old_password" id="old_password" />
                            </div>
                            <div className="mb-3">
                            ...
                            <div className="mb-3">
                                ...
                                <input type="password" className="form-control" placeholder="Confirm Password" name="confirm_password" id="confirm_password" />
                            </div>
