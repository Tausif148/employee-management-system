                    ...
                    <div className="card border-0 shadow">
                        ...
                        <div className="card-body">
                            ...
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" placeholder="Author" name="author" id="author" />
                            </div>

                            <div className="mb-3">
                                <label for="author" className="form-label">Description</label>
                                <textarea name="description" id="description" className="form-control" placeholder="Description" cols="30" rows="5"></textarea>
                            </div>
                            ...
                            <div className="mb-3">
                                <label for="author" className="form-label">Status</label>
